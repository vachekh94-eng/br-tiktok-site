...
const EMOJI_COUNT = 10; // 10 знаков = каждый знак это 10%
...
form.addEventListener('submit', async (e) => {
  ...
  try {
    // 1. Спросить у нашей serverless-функции прямую ссылку на файл без вотермарки
    ...
    // 2. Скачать сам видеофайл с реальным прогрессом
    ...
    if (!total) setProgress(100); // если сервер не прислал размер файла
